...
public class CustomerController {
    ...
    @GetMapping(value = "/search-by-id")
	 public  Flux<CustomerDto> searchCustomerById(@RequestParam(required = false) long customerId) {
	        log.info("CustomerController :: searchCustomerById - customerId: {} ", customerId);
